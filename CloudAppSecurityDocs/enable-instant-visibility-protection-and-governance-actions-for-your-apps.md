...
> |**근 실시간 파일 검색**|✔|✔|해당 없음|✔-Google Business 또는 Enterprise 필요|||서비스 예정||  
> |**제어권 공유**|✔|✔|해당 없음|✔|해당 없음||✔||  
...
|G Suite|G Suite Business 또는 Enterprise 기본 설정<br /><br /> G Suite Enterprise(최소)|슈퍼 관리자|  
|Office 365||전역 관리자|  
|AWS||새로 만든 사용자|  
