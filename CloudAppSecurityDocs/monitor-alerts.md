...
Microsoft Cloud App Security 포털에서 [경고]를 클릭합니다.


![경고 메뉴](./media/alert-menu.png)

경고를 본 후 관심이 없는 경우 **해제**할 수 있습니다. 경고를 해제한 이유를 설명하는 주석을 입력하고 **Cloud App Security 팀에 피드백을 보낼** 수 있습니다. 경고 메커니즘을 계속 향상하기 위해 보안 연구 팀에서 이 피드백을 검토합니다. 

경고를 조사하고 위험을 완화하는 경우 경고를 **해결**할 수 있습니다. 경고가 더 이상 경고 테이블에 표시되지 않습니다. 문제를 조사하기 시작했지만 계속 작업하기 위해 기억해 두려는 경우 **Mark as unread**(읽지 않은 상태로 표시)할 수 있습니다. 향후 경고 일치 항목을 향상하려면 경고와 일치하는 **정책을 조정**할 수도 있습니다. 경고를 해결하면 주석을 입력하는 옵션이 제공되며 **Cloud App Security 팀에 피드백을 보낼** 수도 있습니다.
