...
Cloud App Security 세션 정책을 사용하면 실시간 세션 수준 모니터링에서 클라우드 앱에 대한 세부적인 가시성을 제공하고 사용자 세션에 설정한 정책에 따라 다른 작업을 수행할 수 있습니다. 세션 제어를 통해 [액세스를 완전히 허용하거나 차단](access-policy-aad.md)하는 대신 세션을 모니터링하면서 액세스를 허용하거나 특정 세션 활동을 제한할 수 있습니다. 
