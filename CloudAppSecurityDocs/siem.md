...
4. 마법사에서 이름을 입력하고, **SIEM 형식을 선택**하고, 해당 형식과 관련된 **고급 설정**을 지정합니다. 
   **다음**을 클릭합니다.
...
>   - Linux: rc.local 파일에 **&** 가 포함된 실행 명령을 추가합니다. 예: `java -jar mcas-siemagent-0.87.20-signed.jar [--logsDirectory DIRNAME] [--proxy ADDRESS[:PORT]] --token TOKEN &`
