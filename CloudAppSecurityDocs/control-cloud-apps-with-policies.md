...
예를 들어 **활동 로그**를 찾는 경우 사무실 IP 주소 외부에서의 관리 활동을 봅니다.
...
정책을 만든 후 정책을 사용 또는 사용하지 않도록 설정할 수 있습니다. 이를 통해 정책을 만든 후 중지하기 위해 정책을 삭제하지 않아도 됩니다. 대신, 어떤 이유로 정책을 중지하려는 경우 이를 다시 사용하도록 설정할 때까지 사용하지 않습니다.
