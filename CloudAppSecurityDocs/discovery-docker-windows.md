---
title: "Windows에서 Docker를 사용하여 연속 보고서용 자동 로그 업로드 구성 | Microsoft 문서"
description: "이 항목에서는 Windows에서 Docker를 사용하여 Cloud App Security의 연속 보고서용 자동 로그 업로드를 구성하는 프로세스에 대해 설명합니다."
keywords: 
author: rkarlin
ms.author: rkarlin
manager: mbaldwin
...
> [!NOTE]
> 이 기능은 테넌트에서 점진적으로 출시됩니다. 미리 보기에 추가하려는 경우 고객 지원에 문의하세요.

## <a name="technical-requirements"></a>기술 요구 사항

-   OS: Windows Sever 2016 또는 Windows 10
...
4.  `docker login -u caslogcollector` 명령을 사용하여 docker 허브에 **연결**합니다.

5.  `C0llector3nthusiast` 암호를 사용합니다.
