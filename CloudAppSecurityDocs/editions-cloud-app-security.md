...
---
# <a name="what-are-the-differences-between-cloud-app-security-and-office-365-cloud-app-security"></a>Cloud App Security와 Office 365 Cloud App Security의 차이점은 무엇인가요?
...
Office 365 Cloud App Security는 Office 365에 대한 향상된 가시성과 제어를 제공하는 Cloud App Security의 하위 집합입니다. 여기에는 사용자 활동 로그를 기반으로 한 위협 검색, Office 365 제품과 유사한 기능이 있는 앱에 대한 Shadow IT Discovery, Office 365에 대한 앱 사용 권한 제어가 포함됩니다.
